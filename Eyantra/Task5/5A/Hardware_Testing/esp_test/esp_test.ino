...
// WiFi credentials
const char* ssid = "OnePlus 11 5G";                    //Enter your wifi hotspot ssid
const char* password =  "mahitnahi";               //Enter your wifi hotspot password
const uint16_t port = 8002;
const char * host = "192.168.201.180";                   //Enter the ip address of your laptop after connecting it to wifi hotspot
